using JuniorCandidateCrudApplication.Models;
...
namespace JuniorCandidateCrudApplication.Controllers
{
        ...
        public JsonResult SaveDataInDatabase(StudentViewModel model)
        {
            ...
            try
            {
                if (model.StudentId > 0)
                {
                    ...
                    Stu.Surname = model.Surname;
                    Stu.Email = model.Email;
                    Stu.BirthDate = model.BirthDate;
                    Stu.Phone = model.Phone;
                    Stu.Location = model.Location;
                    Stu.Photo = model.Photo;
